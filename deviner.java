...
public class deviner implements ActionListener{
	private int count= 0;
	...
	public deviner() {
		...
		ranNum.setFont(new Font("bold",font.BOLD,15));
		...
		panel.setBackground(new Color(199, 240, 190));
